...
<form action="grade.do?method=setGradeNoticeStu" method="post" rel="page">
<div class="place" >
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="#">学生</a></li>
		<li><a href="#">查看评分细则</a></li>
	</ul>
</div>
<div class="formbody" >
...
<div style="overflow: auto; width: 100%;">
		...
		<c:if test="${!empty list}">
			...
			<tr  class="tr_css" align="center">
				...
				<td>${list.date}</td>
				<td>
				<a href = "grade.do?method=showGradeInfoStu&id=${list.id}"><font color="blue">查看</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>	
			</tr>
			</c:forEach>
		</c:if>
		<c:if test="${empty list}">
			<tr>
				<td colspan="8" align="center">
					<strong><font color="red">暂时没有公告信息</font></strong>
				</td>
			</tr>
		</c:if>
		</tbody>
