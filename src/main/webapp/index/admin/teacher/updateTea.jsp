...
<form action = "administrator.do?method=updateTea" method = "post" enctype = "multipart/form-data" class="validate" onsubmit="return add();" >
	<input type="hidden" name="id" value="<%=list.get(0).get("id") %>"/>
	<div class="formbody">
		...
		<ul class="forminfo">
			...
			<li>
			 ...
			 <li>
				<label>备注</label>
				<textarea name="content" id="editor_id" value="<%=list.get(0).get("content") %>" cols="100" rows="8" style="width:400px;height:100px" class="dfinput required" placeholder="请输入备注" ></textarea><font color="red">*</font>
			</li>
			<li>
				<label>照片</label>
			...
			<li>
				...
				<a href="administrator.do?method=selTea"><input type="button" class="btn" value="返回"  /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</li>
		</ul>
	</div>
</form>
