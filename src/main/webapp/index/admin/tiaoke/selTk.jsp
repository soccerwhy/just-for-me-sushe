...
<head>
	...
	<link href="<%=basePath %>css/style.css" rel="stylesheet" type="text/css" />
		...
		<%
			...
			jname = jname == null?"":jname;
		%>

<body background="images/a.jpg">
<form action="shangpin.do?method=selTk" method="post" rel="page">
<div class="place">
	<blockquote><span>位置：</span></blockquote>
	<ul class="placeul">
		<li><a href="#">教师建议管理</a></li>
		<li><a href="#">教师建议信息查询</a></li>
	</ul>
</div>
...
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		...
		<table class="imgtable"border = "5" >
			...
			<tr>
				...
				<td>${list.class1}</td>
				<td>
				<a href = "shangpin.do?method=showTk&id=${list.id}"><font color="blue">编辑</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href = "shangpin.do?method=deleteTk&id=${list.id}" onclick="toAdd()" ><font color="blue">删除
					</font></a>
				</td>
	...
	<div class="tools">
		<ul class="toolbar">
			<li class="click"><span><img src="images/t01.png"/></span><a href="shangpin.do?method=showXx">添加教师建议信息</a></li>
		</ul>
	</div>
</div>
