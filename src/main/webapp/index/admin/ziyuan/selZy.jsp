...
<form action="course.do?method=selZy" method="post" rel="page">
<div class="place">
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="#">课程管理</a></li>
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		...
		<table class="imgtable"border = "5" >
			...
			<tr>
				...
				<td>${list.wname}</td>
				<td>${list.ppt}
				<a href="user.do?method=Xzai&id=${list.id}"><font color="red">点击下载</font></a>
				</td>
				<td>${list.tname}</td>
				<td>${list.date}</td>
				<td>
					<a href = "course.do?method=deleteZy&id=${list.id}" onclick="toAdd()"><font color="blue">删除</font></a>
				</td>
