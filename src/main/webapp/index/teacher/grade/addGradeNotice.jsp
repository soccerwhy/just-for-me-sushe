...
<div class="place">
	...
	<ul class="placeul">
		<li><a href="#">首页</a></li>
		<li><a href="#">添加考试公告</a></li>
	</ul>
</div>

<form action = "grade.do?method=addGradeNotice" method = "post" enctype = "multipart/form-data" class="validate" >
	<div class="formbody">
		...
		<ul class="forminfo">
			 <li>
				<label>标题</label>
				<input name="name" id="name" type="text" class="dfinput  required" placeholder="请输入公告标题" />&nbsp;&nbsp;&nbsp;<font color="red">*</font>
			</li>
			 <li>
				<label>内容</label>
			...
			<li>
				...
				<a href="index/teacher/grade/addGradeNotice.jsp"><input type="button" class="btn" value="重置"  /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</li>
		</ul>
	</div>
</form>
