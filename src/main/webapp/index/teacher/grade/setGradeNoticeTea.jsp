...
<form action="grade.do?method=setGradeNoticeTea" method="post" rel="page">
<div class="place" >
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="#">老师</a></li>
		<li><a href="#">管理考试公告信息</a></li>
	</ul>
</div>
<div class="formbody" >
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		<li>
			<label>信息号</label>
			<input name="id" value = "<%=id %>" type="text" class="dfinput" />
		</li>
...
<div style="overflow: auto; width: 100%;">
		...
		<c:if test="${!empty list}">
			...
			<tr  class="tr_css" align="center">
				...
				<td>${list.date}</td>
				<td>
				<a href = "grade.do?method=showGradeInfoTea&id=${list.id}"><font color="blue">查看</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href = "grade.do?method=updGradeInfoTea&id=${list.id}"><font color="blue">修改</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href = "grade.do?method=delGradeInfoTea&id=${list.id}"><font color="blue">删除</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>	
			</tr>
			</c:forEach>
		</c:if>
	...
	<div class="tools">
		<ul class="toolbar">
			<li class="click"><span><img src="images/t01.png"/></span><a href="index/teacher/grade/addGradeNotice.jsp">添加考试公告</a></li>
		</ul>
	</div>
	<br />
		</div>
