...
<form action="grade.do?method=setCourseGradeTea" method="post" rel="page">
<div class="place" >
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="#">老师</a></li>
		<li><a href="#">管理考试分数信息</a></li>
	</ul>
</div>
<div class="formbody" >
	<div class="formtitle" style="cursor: pointer;" id="formtitle"><span>分数信息编号查询</span></div>
...
<div style="overflow: auto; width: 100%;">
		...
		<c:if test="${!empty list}">
			...
			<tr  class="tr_css" align="center">
				...
				<td>${list.grade}</td>
				<td>
				<a href = "grade.do?method=updCourseGradeInfoTea&id=${list.id}"><font color="blue">修改</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href = "grade.do?method=delCourseGradeInfoTea&id=${list.id}"><font color="blue">删除</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>	
			</tr>
			</c:forEach>
		</c:if>
