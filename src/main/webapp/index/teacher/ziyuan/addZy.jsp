...
<form action = "course.do?method=addZy" method = "post" enctype = "multipart/form-data"   class="validate" onsubmit="return add();" >
	<div class="formbody">
		...
		<ul class="forminfo">
			<li>
				<label>文件名</label>
				<input name="wname" id="xilie"  type="text"  class="dfinput required"  placeholder="请输入文件名" /><font color="red">*</font>必填
			</li>
			<li>
				<label>选择文件</label>
			...
			<li>
				<label>&nbsp;</label>
					...
					<a href="index/teacher/ziyuan/addZy.jsp"><input type="button" class="btn" value="返回"/></a>
			</li>
		</ul>
	</div>
</form>
