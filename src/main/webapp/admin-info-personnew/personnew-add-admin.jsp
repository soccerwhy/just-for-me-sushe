...
<form action = "/admin-info-personnew/add-admin" method = "post" enctype = "multipart/form-data" class="validate" onsubmit="return add();" >
	<div class="formbody">
		...
		<ul class="forminfo">
			<li>
				<label>账号</label>
				<input name="studentid" id="studentid" class="dfinput  required" placeholder="请输入账号" />&nbsp;&nbsp;&nbsp;<font color="red">*</font>
			</li>
			<li>
				<label>密码</label>
			 ...
			 <li>
				<label>姓名</label>
				<input name="name" id="name" class="dfinput  required" placeholder="请输入姓名" />&nbsp;&nbsp;&nbsp;<font color="red">*</font>
			</li>
			<li>
				<label>性别</label>
			...
			<li>
				...
				<a href="/admin-info-personnew/add-admin-jsp"><input type="button" class="btn" value="重置"  /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</li>
		</ul>
	</div>
</form>
