...
<div class="formbody">
    ...
    <div class="formtitle"><span>宿舍基本信息</span></div>
    <ul class="forminfo">
        <li>
            <label>宿舍地点</label>
        ...
        <li>
            <label>损坏情况</label>
            <input name="susheguaranteecontent" id="susheguaranteecontent" class="dfinput  required" value="<%=susheguaranteecontent%>" readonly="true"/>&nbsp;&nbsp;&nbsp;
        </li>
        <li>
            <label>整洁情况</label>
            <input name="susheclean" id="susheclean"   class="dfinput  required" value="<%=susheclean%>" readonly="true"/>
        </li>
        <li>
            <label>宿舍成员</label>
            <textarea name="personnamelist" id="personnamelist" class="dfinput  required" readonly="true"><%=personnamelist%></textarea>&nbsp;&nbsp;&nbsp;
        </li>
    </ul>
</div>
<script type="text/javascript">
