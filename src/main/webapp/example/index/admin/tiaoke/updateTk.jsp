...
<head>
	...
	<script type="text/javascript" src="resource/commons/utils.js"></script>
			...
			List<Map<String, String>> list2 = (List<Map<String, String>>)request.getAttribute("list2");
			%>
<body>
<div class="place">
	<span>位置：</span>
...
<form action = "shangpin.do?method=updateTk" method = "post" enctype = "multipart/form-data"  class="validate" onsubmit="return add();" >
	<input name="id" id="xilie"  type="hidden" value="<%=list2.get(0).get("id")%>" class="dfinput required" />
	<div class="formbody">
		<div class="formtitle"><span>修改教师建议信息</span></div>
		<ul class="forminfo">
			<li>
				<label>课程名</label>
			...
			<li>
				...
				<a href="shangpin.do?method=selTk"><input type="button" class="btn" value="返回"/></a>
			</li>
		</ul>
	</div>
</form>
