...
<head>
    ...
    <%
        ...
        String susheid = (String)request.getAttribute("susheid");
    %>
</head>
...
<div class="place">
    ...
    <div class="formbody">
        ...
        <ul class="forminfo">
            ...
            <li>
                <label>宿舍号</label>
                <input name="susheid" id="susheid" class="dfinput  required" value="<%=susheid%>" readonly="true"/>&nbsp;&nbsp;&nbsp;<font color="red">*</font>
            </li>
            <li>
                <label>内容</label>
