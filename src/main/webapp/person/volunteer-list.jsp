...
<form action="/person/obscure-match" method="post">
<div class="formbody">
...
<form action="/person/volunteer-list" method="post">
		...
		<table class="imgtable"border = "5" >
			...
			<tr>
				...
				<td>${list.major}</td>
				<td>
				<a href = "/person/updateVolunteer?id=${list.personid}"><font color="blue">修改</font></a>&nbsp;&nbsp;&nbsp;&nbsp;
				<a href = "/person/deleteVolunteer?id=${list.personid}" onclick="toDelete()" ><font color="blue">删除</font></a>&nbsp;&nbsp;
				</td>
	...
	<div class="tools">
		<ul class="toolbar">
			<li class="click"><span><img src="images/t01.png"/></span><a href="/index/admin/teacher/addTea.jsp">添加学生</a></li>
		</ul>
	</div>
</div>
</form>
<form action="/person/volunteer-list" rel="page">
