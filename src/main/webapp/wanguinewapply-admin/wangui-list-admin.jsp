...
//                    confirmButtonColor:"#dd6b55",}, 红色
                function (inputValue) {
                    ...
                    console.log(xmlhttp);
                    // 2. 发送Ajax请求
                    xmlhttp.open("Post", "/wanguinewapply-admin/updateResultTrue?applyid=" + id + "&reason=" + inputValue, true)
                    xmlhttp.send();
                    // 3. 处理服务器响应
                    swal({
                        title: "提交成功",
...
//                    confirmButtonColor:"#dd6b55",}, 红色
                function (inputValue) {
                    ...
                    console.log(xmlhttp);
                    // 2. 发送Ajax请求
                    xmlhttp.open("Post", "/wanguinewapply-admin/updateResultFalse?applyid=" + id + "&reason=" + inputValue, true)
                    xmlhttp.send();
                    // 3. 处理服务器响应
    ...
    <style type="text/css">
        .whyinput{width:120px; height:27px;  border-top:solid 1px #a7b5bc; border-left:solid 1px #a7b5bc; border-right:solid 1px #ced9df; border-bottom:solid 1px #ced9df; background:url(../images/inputbg.gif) repeat-x; }
    </style>
</head>
<%
...
<form action="/wanguinewapply-admin/obscure-match" method="post">
    <div class="formbody">
        <div class="formtitle" style="cursor: pointer;" id="formtitle"><span>条件查询</span></div>
        <ul class="forminfo" style="display: none;" id="forminfo">
            <li>
                专业:
                <input name="major" id="major" value="" width="550px" height="50px" class="whyinput"/> &nbsp;&nbsp;
            </li>
            <li>
