...
<form action = "/admin-info/single-admin-update" method = "post"   class="validate" onsubmit="return add();" >
    <div class="formbody">
        ...
        <ul class="forminfo">
            ...
            <li>
                <label>用户名</label>
                <input name="username" id="username" class="dfinput  required" value="<%=username%>" readonly="true"/>&nbsp;&nbsp;&nbsp;
            </li>
            <li>
                <label>密码</label>
            ...
            <li>
                ...
                <a href="admin-info/single-admin-update"><input type="button" class="btn" value="返回"/></a>
            </li>
        </ul>
    </div>
</form>
